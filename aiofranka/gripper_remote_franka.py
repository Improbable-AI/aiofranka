"""
Franka Hand gripper controller (sync/remote style API).

Drop-in command surface for Robotiq-style usage, but backed by pylibfranka.Gripper.
"""
...
class FrankaGripperRemoteController:
    """Synchronous controller for the built-in Franka Hand gripper."""
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError("Franka gripper backend requires pylibfranka.") from exc
